...
| Fuzz / hostile input | Garbage is rejected with a typed error, never a panic | `cargo-fuzz`, scheduled |
| Mutation | The suite actually catches bugs | `cargo-mutants`, scheduled |
